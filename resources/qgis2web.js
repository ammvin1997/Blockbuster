...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [117.876067, 15.418888, 124.067908, 19.014671], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([117.876067, 15.418888, 124.067908, 19.014671], map.getSize());
